...
public class FuncionarioService implements MetodosGerais {
    ...
    public Funcionario create(Funcionario funcionario) {
        ...
        utilizador.setSenha(funcionario.getUtilizador().getUsername()); // Pode ser qualquer senha padrão
        utilizador.setEstado(estado);
        utilizador.setTipoUtilizador(funcionario.getUtilizador().getTipoUtilizador());
