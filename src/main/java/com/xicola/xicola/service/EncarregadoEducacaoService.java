...
public class EncarregadoEducacaoService {
    ...
    private Utilizador criarUtilizadorParaEncarregado(EncarregadoEducacao encarregadoEducacao) {
        ...
        utilizador.setSenha(encarregadoEducacao.getEmail()); // Utilizando o email como senha
        utilizador.setEstado(encarregadoEducacao.getEstado()); // Supondo que o estado do utilizador está definido no
