...
-- Started on 2024-10-02 20:21:43
...
-- Name: area_cientifica_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 222
-- Name: area_cientifica_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: categoria_financeira_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 242
-- Name: categoria_financeira_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: detalhe_relatorio_financeiro_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 317
-- Name: detalhe_relatorio_financeiro_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: encarregado_educacao_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 255
-- Name: encarregado_educacao_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: item_ordem_compra_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 323
-- Name: item_ordem_compra_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: manutencao_ativo_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 307
-- Name: manutencao_ativo_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: ordem_compra_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 321
-- Name: ordem_compra_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: participante_evento_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 313
-- Name: participante_evento_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: pauta_final_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 287
-- Name: pauta_final_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: pauta_trimestral_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 285
-- Name: pauta_trimestral_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: presencas_aluno_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 283
-- Name: presencas_aluno_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: relatorio_financeiro_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 315
-- Name: relatorio_financeiro_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: requisicao_material_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 325
-- Name: requisicao_material_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: sector_trabalho_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 244
-- Name: sector_trabalho_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: tipo_avaliacao_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 236
-- Name: tipo_avaliacao_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: tipo_funcionario_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 327
-- Name: tipo_funcionario_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: tipo_material_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 246
-- Name: tipo_material_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
-- Name: tipo_relatorio_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
-- Dependencies: 220
-- Name: tipo_relatorio_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--
...
6	Gestor(a) Financeiro(a)
7	Contador(a)
8	Bibliotecário(a)
9	Recepcionista
10	Inspetor(a) de Alunos
11	Professor(a)
12	Orientador(a) Educacional
13	Supervisor(a) Educacional
14	Auxiliar de Sala de Aula
15	Monitor(a) de Laboratório
16	Zelador(a)
17	Servente
18	Cozinheiro(a)
...
20	Segurança
21	Motorista
22	Técnico(a) de Informática
23	Manutencionista
24	Psicólogo(a) Escolar
25	Assistente Social
26	Mediador(a) Escolar
27	Nutricionista
28	Enfermeiro(a) Escolar
29	Gestor(a) de Tecnologia da Informação
30	Gestor(a) de Manutenção
31	Gestor(a) de Recursos Humanos
32	Gestor(a) de Logística
33	Gestor(a) de Compras
34	Responsável pelo Marketing Escolar
35	Responsável pela Comunicação Institucional
36	Designer Gráfico
\.
...
-- Dependencies: 243
-- Data for Name: categoria_financeira; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
1	Departamento Academico	DEA
3	Departamento Finaceiro	DEF
4	Departamento de Recursos Humanos	DRH
5	Departamento Aquisicoes	DAQ
2	Departamento Pedagogico	DEP
\.
...
-- Dependencies: 267
-- Data for Name: disciplina_aluno; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 322
-- Data for Name: ordem_compra; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 314
-- Data for Name: participante_evento; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
-- Dependencies: 326
-- Data for Name: requisicao_material; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
12	Contrato de Prestação de Serviços Educacionais
13	Regulamento Interno
14	Relatórios de Gestão
15	Atas de Reuniões
16	Plano de Desenvolvimento Escolar
17	Relatórios de Inspeção Escolar
18	Registros de Funcionários
19	Planilhas de Controle Financeiro
20	Recibos de Pagamento
21	Notas Fiscais
22	Relatórios de Orçamento
23	Balancetes
24	Demonstrativos Financeiros
25	Planilhas de Custos
26	Plano de Orçamento Anual
27	Relatórios de Auditoria
28	Contratos de Trabalho
29	Folha de Pagamento
30	Relatórios de Frequência
31	Avaliações de Desempenho
32	Planos de Carreira
33	Relatórios de Treinamento e Desenvolvimento
34	Registros de Férias
35	Circulares Internas
36	Avisos e Comunicados
37	Boletins Informativos
...
1	Estado Geral
2	Estado de Pessoas
3	Estado de Estudante
4	Estado de Professor
5	Estado de Avaliação
6	Estado de Equipamento
7	Estado de Evento
\.
...
1	Pagamento de Mensalidade Escolar
2	Pagamento de Matrícula
3	Pagamento de Material Didático
4	Pagamento de Refeições
5	Pagamento de Transporte Escolar
6	Pagamento de Atividades Extracurriculares
7	Pagamento de Eventos e Excursões
8	Pagamento de Taxas Administrativas
9	Pagamento de Seguro Escolar
10	Pagamento de Doações
11	Outros
\.
...
-- Dependencies: 221
-- Data for Name: tipo_relatorio; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
23	mlmaunze@gmail.com	$2a$10$kuT/TLRdpmuzl2i4NP6NJO2XZFyf3sRYyRoo41InwSiyKE/8YsTC.	mmaunze	Meldo Leonardo Maunze
\.
...
COPY public.utilizador_role (utilizador, role) FROM stdin;
23	12
\.
...
COPY public.veiculo (id, codigo_veiculo, marca_veiculo, motorista, estado) FROM stdin;
\.
...
-- Dependencies: 222
-- Name: area_cientifica_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 242
-- Name: categoria_financeira_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 317
-- Name: detalhe_relatorio_financeiro_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 255
-- Name: encarregado_educacao_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 323
-- Name: item_ordem_compra_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 307
-- Name: manutencao_ativo_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 321
-- Name: ordem_compra_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 313
-- Name: participante_evento_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 287
-- Name: pauta_final_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 285
-- Name: pauta_trimestral_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 283
-- Name: presencas_aluno_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 315
-- Name: relatorio_financeiro_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 325
-- Name: requisicao_material_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 244
-- Name: sector_trabalho_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 236
-- Name: tipo_avaliacao_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
SELECT pg_catalog.setval('public.tipo_estado_id_seq', 7, true);


--
-- TOC entry 5684 (class 0 OID 0)
-- Dependencies: 327
-- Name: tipo_funcionario_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 246
-- Name: tipo_material_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
-- Dependencies: 220
-- Name: tipo_relatorio_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--
...
SELECT pg_catalog.setval('public.utilizador_id_seq', 23, true);
...
-- Name: area_cientifica area_cientifica_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: area_cientifica area_cientifica_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: avaliacao_aluno avaliacao_aluno_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: cargo cargo_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: categoria_financeira categoria_financeira_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: categoria_financeira categoria_financeira_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: departamento departamento_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: departamento departamento_sigla_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: detalhe_relatorio_financeiro detalhe_relatorio_financeiro_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: disciplina_aluno disciplina_aluno_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: disciplina disciplina_nome_disciplina_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: encarregado_aluno encarregado_aluno_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: encarregado_educacao encarregado_educacao_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: item_ordem_compra item_ordem_compra_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: material material_nome_material_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: ordem_compra ordem_compra_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: participante_evento participante_evento_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_final pauta_final_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_trimestral pauta_trimestral_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: presencas_aluno presencas_aluno_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: provincia provincia_nome_provincia_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: relatorio_financeiro relatorio_financeiro_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: requisicao_material requisicao_material_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: sala sala_nome_sala_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: sector_trabalho sector_trabalho_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: sector_trabalho sector_trabalho_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_avaliacao tipo_avaliacao_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_funcionario tipo_funcionario_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_funcionario tipo_funcionario_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_material tipo_material_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_pagamento tipo_pagamento_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_pessoa tipo_pessoa_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_pessoa tipo_pessoa_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_relatorio tipo_relatorio_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_relatorio tipo_relatorio_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: tipo_transacao tipo_transacao_descricao_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: utilizador uk95oprqrxvxhsfbyuagaq71ipg; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: utilizador ukeougu510uft70icifeafv6cll; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: utilizador_role utilizador_role_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: aluno aluno_distrito_nascimento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: aluno aluno_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: aluno aluno_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: ativo ativo_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: aula aula_disciplina_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: aula aula_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: avaliacao_aluno avaliacao_aluno_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: avaliacao_aluno avaliacao_aluno_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: avaliacao avaliacao_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: avaliacao avaliacao_disciplina_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: avaliacao avaliacao_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: avaliacao avaliacao_tipo_avaliacao_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: comunicados comunicados_destinatario_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: comunicados comunicados_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: comunicados comunicados_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: contrato contrato_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: contrato contrato_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: despesa despesa_categoria_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: despesa despesa_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: despesa despesa_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: detalhe_relatorio_financeiro detalhe_relatorio_financeiro_relatorio_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: disciplina_aluno disciplina_aluno_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: disciplina_aluno disciplina_aluno_disciplina_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: distrito distrito_provincia_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: documento documento_autor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: documento documento_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: documento documento_tipo_documento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: encarregado_aluno encarregado_aluno_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: encarregado_aluno encarregado_aluno_encarregado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: encarregado_educacao encarregado_educacao_distrito_nascimento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: encarregado_educacao encarregado_educacao_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: estado estado_tipo_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: evento evento_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: evento evento_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: avaliacao_aluno fk37xrlgvf8p0kl8tajttbt9mh8; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: utilizador_role fk47b6nduvkj7lmjinhlv8s6bto; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: item_ordem_compra fk7woghxkgm4nqiq1kw1o1avecf; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: aluno fkbq5nt66xcxxrb7xbujb2ouqjc; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: encarregado_educacao fknhfbxdjf0455kxn9j95r8h4k1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: encarregado_educacao fko6s10ywoe774dkkjwv4v8hrye; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: utilizador_role fkphtwi61sw0744d9fswd2ehnat; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: funcionario fkpsyut9lh7x4v2m2ssd9ypyna; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: horario fks5plgjbovrcju2vmdt2ptb0fn; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: folha_pagamento folha_pagamento_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: folha_pagamento folha_pagamento_funcionario_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: fornecedor fornecedor_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: funcionario funcionario_area_formacao_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: funcionario funcionario_cargo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: funcionario funcionario_departamento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: funcionario funcionario_distrito_nascimento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: funcionario funcionario_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: funcionario funcionario_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: horario horario_disciplina_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: horario horario_professor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: horario horario_sala_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: horario horario_turma_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: item_ordem_compra item_ordem_compra_material_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: item_ordem_compra item_ordem_compra_ordem_compra_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: manutencao_ativo manutencao_ativo_ativo_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: manutencao_ativo manutencao_ativo_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: manutencao_ativo manutencao_ativo_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: material material_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: material material_tipo_material_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: matricula matricula_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: matricula matricula_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: orcamento orcamento_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: orcamento orcamento_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: ordem_compra ordem_compra_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: ordem_compra ordem_compra_fornecedor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: ordem_compra ordem_compra_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pagamento pagamento_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pagamento pagamento_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pagamento pagamento_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pagamento pagamento_tipo_pagamento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: participante_evento participante_evento_evento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: participante_evento participante_evento_tipo_participante_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_final pauta_final_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_final pauta_final_disciplina_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_final pauta_final_estado_pauta_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_final pauta_final_professor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_trimestral pauta_trimestral_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_trimestral pauta_trimestral_disciplina_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_trimestral pauta_trimestral_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: pauta_trimestral pauta_trimestral_professor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: presencas_aluno presencas_aluno_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: presencas_aluno presencas_aluno_disciplina_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: presencas_aluno presencas_aluno_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: presencas_aluno presencas_aluno_turma_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: professor professor_area_formacao_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: professor_disciplina professor_disciplina_disciplina_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: professor_disciplina professor_disciplina_professor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: professor professor_distrito_nascimento_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: professor professor_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: receita receita_categoria_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: receita receita_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: receita receita_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: relatorio_financeiro relatorio_financeiro_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: relatorio_financeiro relatorio_financeiro_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: relatorio_financeiro relatorio_financeiro_tipo_relatorio_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: requisicao_material requisicao_material_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: requisicao_material requisicao_material_material_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: requisicao_material requisicao_material_requisitor_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: transacao transacao_categoria_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: transacao transacao_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: transacao transacao_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: transacao transacao_tipo_transacao_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: turma_aluno turma_aluno_aluno_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: turma_aluno turma_aluno_turma_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: turma turma_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: turma turma_professor_responsavel_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: veiculo veiculo_estado_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
-- Name: veiculo veiculo_motorista_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
